...
assert stats["deep_reads"] + stats["targeted_additional"] + stats[
    "screened_only"
] == len(rows)
print(
    "PASS: 100 unique CSV/BibTeX records, 25 complete deep-read structures, "
    "JSON, relative links and report sections."
)
