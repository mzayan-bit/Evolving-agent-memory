...
## Provider implementation check — 2026-09-26

Native Messages adapter now targets the officially documented `claude-sonnet-5`; unsupported sampling settings are omitted and raw usage retained. [Official identifier, behavior and standard rates](https://platform.claude.com/docs/en/models/sonnet-5/overview). This recheck does not imply account access. Credential presence check and smoke runner found no configured API key; live result SKIPPED.
